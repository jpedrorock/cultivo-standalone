...
## Implementação do Tema Liquid Glass

### Fase 1 - Foundation (Fundação)
- [x] Atualizar variáveis CSS de cores no index.css
  - [x] Paleta primária (Forest Green, Earth Brown, Sky Blue)
  - [x] Cores semânticas (Success, Warning, Critical, Info)
  - [x] Neutrals para light/dark mode
  - [x] Glass tints por fase (vegetativa, floração, manutenção)
- [x] Integrar fonte SF Pro
  - [x] Adicionar SF Pro Display, Text, e Rounded via @font-face
  - [x] Configurar font-family no body (index.css)
  - [x] Sistema de fonts Apple com fallbacks
- [x] Implementar sistema de espaçamento 8px grid
  - [x] Atualizar container padding (16/24/32px)
  - [x] Component spacing via Tailwind
  - [x] Touch targets mínimos 44px (mobile)
- [x] Criar utilitários Tailwind para glass effects
  - [x] Backdrop blur (20px, 30px, 40px)
  - [x] Glass classes (light/medium/heavy)
  - [x] Border hairline (0.5px)
  - [x] Glass shadows (soft, diffused)
  - [x] Phase-tinted glass (vega/flora/maintenance)
  - [x] Spring/morph animations

### Fase 2 - Navigation (Navegação)
- [x] Redesenhar Bottom Tab Bar com Liquid Glass
  - [x] Glass background (glass-light class)
  - [x] Floating style (rounded-3xl, mx-4 mb-2)
  - [x] Selected tab com pill background (bg-primary/10)
  - [x] Smooth scale animations (active:scale-95)
  - [x] Hairline borders (border-hairline-light)
  - [x] Shadow-glass effect
- [x] Redesenhar Sidebar (tablet/desktop)
  - [x] Glass background (glass-heavy)
  - [x] Hairline borders throughout
  - [x] Selected item styling (bg-primary/10 pill)
  - [x] Status card com glass-light
  - [x] Active indicator (green dot pulse)

### Fase 3 - Cards e Panels
- [ ] Rebuild Tent Cards com glass aesthetic
  - [ ] Card container (88% opacity, 30px blur, 20px radius)
  - [ ] Phase-tinted header com badge
  - [ ] Environmental metrics grid com status indicators
  - [ ] Ciclo Ativo section com phase-tinted inset
  - [ ] Action buttons com hierarquia visual
- [ ] Criar Metric Cards
  - [ ] Large value display (48pt semibold)
  - [ ] Trend indicator
  - [ ] Sparkline graph
- [ ] Implementar List Cards
  - [ ] Glass container
  - [ ] Hairline separators
  - [ ] Proper touch targets (56pt)

### Fase 4 - Forms e Controls
- [ ] Atualizar Text Fields
  - [ ] Glass background (80% opacity)
  - [ ] Focus states (90% opacity, 2px accent border)
  - [ ] Error states
- [ ] Redesenhar Buttons
  - [ ] Primary (accent green glass, white text)
  - [ ] Secondary (neutral glass, label color)
  - [ ] Destructive (red-tinted glass)
  - [ ] Hover/press states com morphing
- [ ] Implementar glass-styled controls
  - [ ] Toggle switches
  - [ ] Sliders com glass thumb
  - [ ] Segmented controls

### Fase 5 - Dialogs e Modals
- [ ] Redesenhar Phase Transition Dialog
  - [ ] Glass panel (92% opacity, 40px blur, 24px radius)
  - [ ] Phase-tinted card
  - [ ] Smooth morphing animations
- [ ] Atualizar Harvest Confirmation Dialog
  - [ ] Checklist com glass rows
  - [ ] Disabled state até completion
- [ ] Implementar Action Sheets
  - [ ] Slide-up animation
  - [ ] Drag handle
  - [ ] Drag-to-dismiss gesture

### Fase 6 - Polish e Otimização
- [ ] Refinar todas as animações
  - [ ] Spring curves (0.25, 0.1, 0.25, 1.0)
  - [ ] Morphing transitions (0.4s)
  - [ ] Hover/press feedback (0.2s)
- [ ] Otimizar performance de blur
